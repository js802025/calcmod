...
public class Distance {
    ...
    public static CalcMessageBuilder execute(BlockPos pos1, BlockPos pos2) {
        double dist = Math.sqrt(Math.pow(pos1.getX()-pos2.getZ(), 2) + Math.pow(pos1.getY()-pos2.getZ(), 2));
    ...
    public static String helpMessage = """
        §b§LDistance:§r§f
            Given two block positions, gives distance between them. If only one position is given, uses player's location.

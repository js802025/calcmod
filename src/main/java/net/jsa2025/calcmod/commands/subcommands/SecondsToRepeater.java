...
public class SecondsToRepeater {
    ...
    public static LiteralArgumentBuilder<FabricClientCommandSource> register(LiteralArgumentBuilder<FabricClientCommandSource> command) {
        ...
        .executes(ctx -> {
            String[] message = execute(StringArgumentType.getString(ctx, "seconds"));
    ...
    public static String[] execute(String seconds) {
        double secondsDouble = CalcCommand.getParsedExpression(seconds);
